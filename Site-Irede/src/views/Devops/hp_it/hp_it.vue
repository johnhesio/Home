...
export default defineComponent({ name: "hp_it", })
...
<template>
    <div>
        ...
        <img src="../../../assets/Imagens/cases_de_sucesso/devops_basico _e_quality_assurance/devops_basico _e_quality_assurance_capa.jpg" alt=""
            class="w-full">

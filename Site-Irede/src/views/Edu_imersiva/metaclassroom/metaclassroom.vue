...
export default defineComponent({ name: "metaclassroom", })
    ...
    <div>
        <div class="relative flex flex-col">
            <div class="absolute md:w-[50%] md:top-24 md:left-20 left-5 top-5">
                <h2 class="font-bold md:text-3xl text-[#8b47fe] md:pb-2">METACLASSROOM</h2>
        ...
        <img src="../../../assets/Imagens/cases_de_sucesso/educacao_imersiva/educacao_imersiva_capa_2.jpg" alt=""
            class="w-full">
